/*
  # Fix Product UUID Issues

  1. Changes
    - Remove existing products with invalid UUID format
    - Insert new products with proper UUIDs
...
-- First, clear any existing products that might have invalid UUIDs
