...
const HomePage = () => {
  const [trendingProducts, setTrendingProducts] = useState(featuredProducts.slice(0, 4));
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
              ...
              <p className="text-neutral-600 mb-6">
                Every product on Evolv is rated for sustainability. We analyze materials, production methods, 
